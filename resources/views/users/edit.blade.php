...
<div class="min-h-[60vh] bg-gray-50 dark:bg-gray-900/50">
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <div class="mb-8">
            ...
            <p class="mt-1 text-gray-500 dark:text-gray-400">Change name, email, role or password.</p>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/80 shadow-sm overflow-hidden">
            <form action="{{ route('users.update', $user) }}" method="POST" class="p-6 sm:p-8">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">New Password (leave blank to keep current)</label>
                    ...
                    <div>
                        ...
                        <select name="role" id="role"
                                class="block w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 px-4 py-3 text-gray-900 dark:text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition outline-none">
                            <option value="admin" {{ old('role', $user->role) === 'admin' ? 'selected' : '' }}>Admin (no system settings / import / backup / user management)</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="stock_password" id="stock_password" value="{{ old('stock_password', $user->stock_password) }}"
                               class="block w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 px-4 py-3 text-gray-900 dark:text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition outline-none">
