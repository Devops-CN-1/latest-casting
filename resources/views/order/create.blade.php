    ...
    function fetchOldParchies(id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#op2cash').val((data.op2RemainingGold * data.mazdoriRate   ).toFixed(3));
                ...
                // ✅ Option 3 fields
                $('#op3cash').val(Math.ceil(data.totalKhalis * data.mazdoriRate ).toFixed(3));
                ...
                let totalop3totalCashwithMazdooriInCash = (Math.ceil(data.totalKhalis * data.mazdoriRate ) + Math.ceil(data.totalMazdoori)).toFixed(3);
